...
def calendario(base, giornate, ora=None):
    ...
    for n, sa, _, partite in (g[:4] for g in base['g']):
        ...
        # niente nome dell'avversario: il file è pubblico e il Calendario dell'iPhone non sa
        # aprire il lucchetto (16/09/2026); l'avversario lo dice Jarvis
        titolo = f'Schiera la formazione · G{n}'
