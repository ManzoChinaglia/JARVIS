...
21/09/2026): regole, struttura, come si lavora e stato di oggi. Il perché delle scelte,
le indagini fatte, le idee scartate e le date stanno in **`STORIA.md`**: non si carica a
ogni sessione, **si legge prima di riaprire una questione** o quando serve sapere come mai
qualcosa è fatto così. Qui si aggiorna lo stato; le note storiche nuove, datate, vanno in
fondo a `STORIA.md`.
