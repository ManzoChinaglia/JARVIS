# Storia di Jarvis, fino al 21/09/2026

Copia integrale del CLAUDE.md com'era il 21/09/2026, prima dello snellimento: indagini,
scelte scartate e il perché di ogni decisione, con le date. **Non si carica a ogni
sessione**: si legge quando serve (prima di riaprire una questione, o per sapere come
mai qualcosa è fatto così). Le note storiche nuove si aggiungono in fondo, datate.
Le regole e lo stato di oggi stanno in CLAUDE.md, che vince in caso di contrasto.

---

## Il CLAUDE.md del 21/09/2026
